	...
	<tr>
		...
		<td>
			...
			<a>
				...
				<xsl:attribute name="onclick">this.target=getTarget('<xsl:value-of select="./url"/>');</xsl:attribute>
		...
		<tr>
			...
			<td width="96%" valign="top">
				...
				<a>
					...
					<xsl:attribute name="onclick">this.target=getTarget('<xsl:value-of select="vpath"/>');</xsl:attribute>
